...
namespace webfmis.Controllers
{
    ...
    {
        public const int ARTICLE_TYPE = 3;

        public IActionResult Index()
        {
            ViewData["UserRights"] = Library.Security.GetFormRights("MstSupplier");
        ...
        public async Task<IActionResult> SupplierGroups([DataSourceRequest] DataSourceRequest request)
        {
